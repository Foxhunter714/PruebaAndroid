...
public class YoutubeChannelMapper {
    ...
    //YouTubeChannelSchema-> Domain Model
    public DomainModel mapSchemaToModel(YouTubeChannelSchema schema){
        return new DomainModel(schema.getNombre(), schema.getType(), schema.getDescripcion(), schema.getVideoUrl(), schema.getImageUrl(), schema.getFecha());
    }
    //DomainModel-> YoutubeChannelSchema
    public YouTubeChannelSchema mapModelToSchema(DomainModel model){
        return new YouTubeChannelSchema(model.getNombre(), model.getType(), model.getDescripcion(), model.getVideoUrl(), model.getImageUrl(), model.getFecha());
    }
}
